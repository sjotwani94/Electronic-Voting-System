...
public class VoterHomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleTextView.setText("Voter Handle");
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.logout:
                        AlertDialog.Builder dialogx = new AlertDialog.Builder(VoterHomePage.this);
                        ...
                        dialogx.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent1 = new Intent(VoterHomePage.this, MainActivity.class);
                                SharedPreferences.Editor editor = sharedpreferences.edit();
                                editor.clear();
                                editor.apply();
                                startActivity(intent1);
                                Toast.makeText(VoterHomePage.this, "Logged Out",Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
                    ...
                    case R.id.delete_account:
                        AlertDialog.Builder dialog = new AlertDialog.Builder(VoterHomePage.this);
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                dbRef.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        Intent int1=new Intent(VoterHomePage.this,MainActivity.class);
                                        String userkey = DatabaseHelper.retrieveKey(snapshot,Email);
                                        DatabaseHelper.deleteVoter(userkey);
                                        SharedPreferences.Editor editor = sharedpreferences.edit();
                                        editor.clear();
                                        editor.apply();
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ElectionListAdapter(VoterHomePage.this,functionsList);
